function[x] = newton(f, gradf, hessf, TOL)


endfuntion
syms X Y;
f = 12*Y^2-4*X^2-4*Y^2+4*X*Y;
...
// https://www.mathworks.com/matlabcentral/fileexchange/62012-newtonian-method-optimizing-two-variable-functions
